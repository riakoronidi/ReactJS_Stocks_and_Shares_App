...
return(
  <React.Fragment>
    ...
    <div className="stock-div">
      ...
      <BootstrapTable keyField='symbol' data={props.stock} columns={columns} rowStyle={ { backgroundColor: 'dimgray' ,color:'white', 'textShadow': '2px 2px black'} } loading={ true } striped />
    </div>
